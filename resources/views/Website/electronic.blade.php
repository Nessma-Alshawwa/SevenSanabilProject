        ...
        <div class="row d-flex justify-content-evenly mb-4">
            <div class="col-3">
                <div class="card bgColor5 p-4 shadow"
                    style="width: 18rem;">
                    <img src="{{ asset('dist/img/e1.jpg') }}"
                        class="align-self-center rounded"
                        alt="..."
                        style="width: 80%;height: 50%;">
                    <div class="card-body"
                        style="z-index: 1;">
                    <h5 class="card-title text-center color2 p-4">هاتف محمول</h5>
                    <p class="text-white">
            ...
            <div class="col-3">
                <div class="card bgColor5 p-4 shadow"
                    style="width: 18rem;">
                    <img src="{{ asset('dist/img/e2.jpg') }}"
                        class="align-self-center rounded"
                        alt="..."
                        style="width: 80%;height: 50%;">
                    <div class="card-body"
                        style="z-index: 1;">
                    <h5 class="card-title text-center color2 p-4">مكواة كهربائية</h5>
                    <p class="text-white">
                        لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور
                    </p>
                    <a href="#"
            ...
            <div class="col-3">
                <div class="card bgColor5 p-4 shadow"
                    style="width: 18rem;">
                    <img src="{{ asset('dist/img/e3.jpg') }}"
                        class="align-self-center rounded"
                        alt="..."
                        style="width: 80%;height: 50%;">
                    <div class="card-body"
                        style="z-index: 1;">
                    <h5 class="card-title text-center color2 p-4">خلاط كهربائي</h5>
                    <p class="text-white">
                        لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور
                    </p>
                    <a href="#"
